...
<form action="?page=salvar-cliente" method="POST">
	<input type="hiddem" name="acao" value="editar">
	...
	<div class="mb-3">
		<label>Cpf
			<input type="cpf" name="cpf_cliente" class="form-control" value="<?php print $row->cpf_cliente; ?>">
		</label>
	</div>
	<div class="mb-3">
		<label>E-mail
	...
	<div class="mb-3">
		<label>Telefone
			<input type="email" name="telefone_cliente" class="form-control" value="<?php print $row->telefone_cliente; ?>">
		</label>
	</div>
	<div class="mb-3">
		<label>Endereço
